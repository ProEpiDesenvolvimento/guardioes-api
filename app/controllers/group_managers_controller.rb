class GroupManagersController < ApplicationController
  ...
  private
    ...
    def group_manager_params
      params.require(:group_manager).permit(:email, :password_changed, :password, :name, :app_id, :group_name, :twitter, :require_id, :id_code_length, :vigilance_email, :vigilance_syndromes, :username_godata, :password_godata)
    end

    def update_params
      params.require(:group_manager).permit(:email, :password_changed, :password, :name, :app_id, :group_name, :twitter, :require_id, :id_code_length, :vigilance_email, :username_godata, :password_godata, :userid_godata)
    end
